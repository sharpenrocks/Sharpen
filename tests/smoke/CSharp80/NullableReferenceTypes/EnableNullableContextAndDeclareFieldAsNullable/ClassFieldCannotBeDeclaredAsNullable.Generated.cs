...
{
    public class ClassFieldCannotBeDeclaredAsNullableGenerated
    {
        ...
        public void AllFieldsAreNullableForDifferentReasons()
        {
            ...
            ClassFieldCannotBeDeclaredAsNullableGenerated.StaticAssignedNullUsingClassName = null;

            if (ClassFieldCannotBeDeclaredAsNullableGenerated.StaticComparedEqualToNullOnLeftUsingClassName == null) return;
            if (null == ClassFieldCannotBeDeclaredAsNullableGenerated.StaticComparedEqualToNullOnRightUsingClassName) return;
            if (ClassFieldCannotBeDeclaredAsNullableGenerated.StaticComparedNotEqualToNullOnLeftUsingClassName != null) return;
            if (null != ClassFieldCannotBeDeclaredAsNullableGenerated.StaticComparedNotEqualToNullOnRightUsingClassName) return;

            ClassFieldCannotBeDeclaredAsNullableGenerated.StaticAssignedResultOfAsOperatorUsingClassName = assignedNull as string;
            ClassFieldCannotBeDeclaredAsNullableGenerated.StaticUsedInConditionalAccessUsingClassName?.Length.ToString();
            dummy = ClassFieldCannotBeDeclaredAsNullableGenerated.StaticUsedInCoalesceExpressionUsingClassName ?? string.Empty;
