...
{
    public const string Title = "Sharpen Engine for Roslyn 2.4.0.0";

    public const string Description = "Implementation of Sharpen Engine that uses Roslyn version 2.4.0.0.";
