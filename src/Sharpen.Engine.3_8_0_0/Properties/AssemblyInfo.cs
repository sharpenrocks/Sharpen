...
{
    public const string Title = "Sharpen Engine for Roslyn 3.8.0.0";

    public const string Description = "Implementation of Sharpen Engine that uses Roslyn version 3.8.0.0.";
